...
export const Question = forwardRef<HTMLDivElement, QuestionProps>(
  function Question({ css, isTimerRunning, onTimeUp, question }, ref) {
    ...
    return (
      <div
        ref={ref}
        css={[
          tw`flex flex-col w-full max-w-6xl rounded-3xl bg-white ring ring-green-900 z-10 overflow-hidden`,
          css,
        ]}
      >
